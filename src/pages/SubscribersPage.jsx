...
function localDateToMs(isoDate) {
...
/* =========================
   Date math (calendar-safe)
   ========================= */
function addDaysLocal(baseMs, days) {
  const d = new Date(baseMs);
  return new Date(d.getFullYear(), d.getMonth(), d.getDate() + Number(days || 0), 0, 0, 0, 0).getTime();
}
...
/* =========================
   Normalizers (Lines / Packages / Subscribers)
   ========================= */
...
const btnTiny2 = { padding: "8px 12px", borderRadius: 999, border: "none", backgroundColor: primary, color: "#fff", fontWeight: 900, cursor: "pointer", fontSize: 12, whiteSpace: "nowrap" };
